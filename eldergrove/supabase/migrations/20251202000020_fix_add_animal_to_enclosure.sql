-- Fix add_animal_to_enclosure function to verify UPDATE actually affected rows
-- This ensures animals are properly added to enclosures
...
COMMENT ON FUNCTION public.add_animal_to_enclosure(integer, integer, integer) IS 'Add an animal to an enclosure slot (fixed to verify UPDATE success)';
