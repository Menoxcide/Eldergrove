-- Fix start_factory_production RPC to use correct column names and handle item name to ID mapping
-- The recipes table uses 'input', 'output', 'minutes' columns (not 'input_items', 'output_items', 'duration_minutes')
