-- Fix collect_factory function to return crystal balance and crystals awarded
-- This ensures the frontend can properly update the crystal balance without race conditions
