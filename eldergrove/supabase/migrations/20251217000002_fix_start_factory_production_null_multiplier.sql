-- Fix start_factory_production RPC to handle NULL from get_production_speed_multiplier
-- Use COALESCE to provide default multiplier of 1.0 when function returns NULL
