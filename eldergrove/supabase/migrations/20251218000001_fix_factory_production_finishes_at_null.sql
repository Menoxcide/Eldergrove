-- Fix start_factory_production RPC to ensure finishes_at is never NULL
-- Add validation and safeguards to prevent NULL values in production time calculation
...
BEGIN
  ...
  -- This approach works with numeric values and was used successfully in previous migrations
