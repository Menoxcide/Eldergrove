-- Fix place_building function to ensure correct signature and search_path
-- This migration ensures the function is properly defined with SET search_path for security
